---
name: pyth
description: Decentralized oracle price feeds for Solana — real-time prices, confidence intervals, Anchor integration. Triggers on "Pyth", "price feed", "oracle Solana", "price oracle", "real-time prices".
---
