---
name: jupiter
description: Solana DeFi aggregator — Ultra Swap, Perps, DCA, Price, Token APIs. Triggers on "Jupiter swap", "token swap Solana", "Jupiter API", "DEX aggregator", "DCA order".
---
