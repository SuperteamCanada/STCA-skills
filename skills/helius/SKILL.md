---
name: helius
description: Solana RPC and API infrastructure — DAS API, webhooks, priority fees, Enhanced Transactions. Triggers on "Helius", "DAS API", "Solana RPC", "priority fees", "NFT indexing".
---
